...
VALUES (001, 'Phan Quoc An', '30 Nguyen Chu Trinh', 'hammer', 5);
INSERT INTO Customer (Customer_id, Customer_name, Address, Item_name, Required_amount)
VALUES (002, 'Nguyen Tien', '25 Nguyen Ha Ki', 'Pipe', 15);
INSERT INTO Customer (Customer_id, Customer_name, Address, Item_name, Required_amount)
VALUES (003, 'Hoang Van Hau', '155/A Nguyen Trai', 'PC case', 1);
INSERT INTO Customer (Customer_id, Customer_name, Address, Item_name, Required_amount)
VALUES (004, 'Nguyen Van A', '154/B Ly Thuong Kiet', 'Iphone 13', 2);
INSERT INTO Customer (Customer_id, Customer_name, Address, Item_name, Required_amount)
VALUES (005, 'Nguyen Thi Hoa', '22 Le Quy Don', 'Condom packs', 10);
...
-- select a.Customer_id, a.Customer_name, b.Money_pending from customer as a join Defaulters as b on a.Customer_id = Defaulters_id;
